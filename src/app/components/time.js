 ...
 Time Slots
  ...
  <tbody>
    <tr className=' font-semibold'>
      <td className='border border-slate-700 P-3 hover:bg-slate-200'>Session One</td>
      <td className='border border-slate-700 p-3 hover:bg-slate-200'>Session Two</td>
      <td className='border border-slate-700 p-3 hover:bg-slate-200'>Session Three</td>
      <td className='border border-slate-700 p-3 hover:bg-slate-200'>Session Four</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td></td>
        <td></td>
        <td className='border border-slate-700 p-3 bg-black text-white font-medium capitalize hover:bg-slate-700 transition duration-500'> Register</td>
    </tr>
  </tbody>
</table>
    </div>
